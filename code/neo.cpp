...
/* Initial position */
void neo_biped::initial_position() {
...
void neo_biped::move_servo(int time, int  servo_target[]) {
...
void neo_biped::say_hi(int count, int speed) {
...
void neo_biped::hands_up(int count, int speed) {
...
void neo_biped::forward(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
  int degree_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
...
void neo_biped::turn_right(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
...
void neo_biped::turn_left(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
...
void neo_biped::move_right(int steps, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= steps; i++) {
...
void neo_biped::move_left(int steps, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= steps; i++) {
...
void neo_biped::ball_kick_right(int count, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= count; i++) {
...
void neo_biped::ball_kick_left(int count, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= count; i++) {
...
void neo_biped::max_sit(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::right_bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::left_bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::ape_move(int count, int speed) {
...
void neo_biped::push_up(int count, int speed) {
  int degree_array1[20] = {90, 70, 60, 30, 90, 90, 90, 110, 120, 150, 90, 90, 30, 60, 30, 150, 120, 150, 90, 90};
...
void neo_biped::clap(int count, int speed) {
...
void neo_biped::right_leg_up(int count, int speed) {
...
void neo_biped::left_leg_up(int count, int speed) {
...
void neo_biped::hip_pose(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::right_leg_balance(int count, int speed) {
  for (int i = 1; i <= count; i++) {
    int degree_array1[20] = {70, 150, 150, 30, 90, 90, 70, 30, 30, 150, 70, 90, 30, 90, 30, 150, 90, 150, 90, 90};
...
void neo_biped::left_leg_balance(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void neo_biped::flying_action(int count, int speed) {
...
void neo_biped::hand_sit_zigzak(int count, int speed) {
...
void neo_biped::side_shake(int count, int speed) {
...
void neo_biped::hip_shake(int count, int speed) {
...
void neo_biped::bend_up(int count, int speed) {
